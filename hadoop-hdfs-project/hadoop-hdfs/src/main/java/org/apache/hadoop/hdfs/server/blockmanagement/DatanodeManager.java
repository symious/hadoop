...
public class DatanodeManager {
   ...
   */
  public void initSlowPeerTracker(Configuration conf,
      Timer timer, boolean dataNodePeerStatsEnabled) {
  ...
  public boolean refreshTopology(final Configuration conf,
      final String ipAddr) throws IOException {
  ...
  private BlockRecoveryCommand getBlockRecoveryCommand(String blockPoolId,
    ...
    for (BlockInfo b : blocks) {
      ...
      List<DatanodeStorageInfo> recoveryLocations = new ArrayList<>(storages.length);
