...
public class NameNodeRpcServer implements NamenodeProtocols {
  ...
  public ReplicatedBlockStats getReplicatedBlockStats() throws IOException {
    throw new UnsupportedActionException(
        "getReplicatedBlockStats is not yet supported in 2.10.");
  }

  @Override // ClientProtocol
  public ECBlockGroupStats getECBlockGroupStats() throws IOException {
    throw new UnsupportedActionException(
        "getECBlockGroupStats is not yet supported in 2.10.");
  }
  ...
  public void setErasureCodingPolicy(String src, String ecPolicyName)
      throws IOException {
    throw new UnsupportedActionException(
        "setErasureCodingPolicy is not yet supported in 2.10.");
  }
  ...
  public ErasureCodingPolicy getErasureCodingPolicy(String src) throws IOException {
    checkNNStartup();
    throw new UnsupportedActionException(
        "getErasureCodingPolicy is not yet supported in 2.10.");
  }

  @Override // ClientProtocol
  public void unsetErasureCodingPolicy(String src) throws IOException {
    throw new UnsupportedActionException(
        "unsetErasureCodingPolicy is not yet supported in 2.10.");
  }
