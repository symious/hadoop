...
public class NameNodeRpcServer implements NamenodeProtocols {
  ...
  private final boolean clientRPCSdiAuthEnabled;
  private final boolean serviceRPCSdiAuthEnabled;
  ...
  public NameNodeRpcServer(Configuration conf, NameNode nn)
    ...
    clientRPCSdiAuthEnabled = conf.getBoolean(
        CommonConfigurationKeys.HADOOP_CLIENT_RPC_SDI_AUTHENTICATION_ENABLED,
        false);
    serviceRPCSdiAuthEnabled = conf.getBoolean(
