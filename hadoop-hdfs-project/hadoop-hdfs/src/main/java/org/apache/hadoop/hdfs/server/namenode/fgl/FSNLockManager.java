...
public interface FSNLockManager {
  ...
  /**
   * Try to set the wait threshold of the lock.
   * @param lockWaitThresholdNs wait threshold.
   */
  void setLockWaitThresholdNs(long lockWaitThresholdNs);

  /**
   * Try to get the wait threshold of the lock.
   * @return the wait threshold.
   */
  long getLockWaitThresholdNs();
