...
/**
 * A simple manager that ignores bandwidth suggestions by namenodes
 */
public class ThrottlerCalibrationSlavePolicyNoCalibration
    extends ThrottlerCalibrationSlavePolicy {
  public ThrottlerCalibrationSlavePolicyNoCalibration(Configuration conf) {
    super(conf);
  }
