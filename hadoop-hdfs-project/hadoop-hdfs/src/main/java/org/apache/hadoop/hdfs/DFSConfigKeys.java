...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final String  DFS_DATANODE_USE_DN_HOSTNAME =
      HdfsClientConfigKeys.DFS_DATANODE_USE_DN_HOSTNAME;
  public static final boolean DFS_DATANODE_USE_DN_HOSTNAME_DEFAULT =
  ...
  public static final String  DFS_NAMENODE_SYMLINKS_ENABLED_KEY = "dfs.namenode.symlinks.enabled";
  public static final boolean DFS_NAMENODE_SYMLINKS_ENABLED_DEFAULT = false;
  public static final String  DFS_NAMENODE_MAX_SYMLINKS_RESOLVES_DEPTH = "dfs.namenode.max.symlinks.resolves.depth";
  public static final int DFS_NAMENODE_MAX_SYMLINKS_RESOLVES_DEPTH_DEFAULT = 5;
  ...
  public static final String  DFS_NAMENODE_EDITS_ASYNC_PENDING_QUEUE_CAPACITY_KEY =
  ...
  public static final String  DFS_NAMENODE_REMOVE_CORRUPTED_BLOCKS_KEY = "dfs.namenode.remove.corrupted.blocks";
  public static final boolean DFS_NAMENODE_REMOVE_CORRUPTED_BLOCKS_DEFAULT = false;
  ...
  // Whether to enable datanode's xceiverCount based sorting usage for reads
  public static final String DFS_NAMENODE_AVOID_HIGH_LOAD_FOR_READ_KEY = "dfs.namenode.avoid.read.high.load.datanode";
  public static final boolean DFS_NAMENODE_AVOID_HIGH_LOAD_FOR_READ_DEFAULT = false;
  ...
  public static final int DFS_DATANODE_RECONCILE_BLOCKS_BATCH_SIZE_DEFAULT = 1000;
  ...
  public static final String  DFS_NAMENODE_EC_SYSTEM_DEFAULT_POLICY_DEFAULT =
      "RS-6-3-1024k";
  public static final String  DFS_DN_EC_RECONSTRUCTION_STRIPED_READ_BUFFER_SIZE_KEY =
      HdfsClientConfigKeys.DFS_DN_EC_RECONSTRUCTION_STRIPED_READ_BUFFER_SIZE_KEY;
  public static final int     DFS_DN_EC_RECONSTRUCTION_STRIPED_READ_BUFFER_SIZE_DEFAULT =
  ...
  public static final String DFS_DATANODE_DIRECTORYSCAN_MAX_NOTIFY_COUNT_KEY =
      "dfs.datanode.directoryscan.max.notify.count";
  public static final long DFS_DATANODE_DIRECTORYSCAN_MAX_NOTIFY_COUNT_DEFAULT = 5;
  ...
  public static final String DFS_BALANCER_LONG_TAIL_BLOCK_THRESHOLD_KEY =
      "dfs.balancer.long-tail.block.threshold";
