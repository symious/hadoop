  ...
  private class SafeModeMonitor implements Runnable {
    ...
    public void run() {
      while (namesystem.isRunning()) {
        try {
          namesystem.writeLock(FSNamesystemLockMode.GLOBAL, OperationName.LEAVE_SAFE_MODE);
          ...
          namesystem.writeUnlock(FSNamesystemLockMode.GLOBAL, OperationName.LEAVE_SAFE_MODE);
        }
