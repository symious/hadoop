...
public class TestReconstructStripedBlocksWithRackAwareness {
  ...
  public void testReconstructForNotEnoughRacks() throws Exception {
    ...
    fsn.writeLock(FSNamesystemLockMode.BM, "testReconstructForNotEnoughRacks");
    try {
  ...
  public void testReconstructionWithDecommission() throws Exception {
    ...
    cluster.getNamesystem().writeLock(FSNamesystemLockMode.BM, "testReconstructionWithDecommission");
    try {
      dn9.stopDecommission();
      decomManager.startDecommission(dn9);
    } finally {
      cluster.getNamesystem().writeUnlock(FSNamesystemLockMode.BM, "testReconstructionWithDecommission");
    }
