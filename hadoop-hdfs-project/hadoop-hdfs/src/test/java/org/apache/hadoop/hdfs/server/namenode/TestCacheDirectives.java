...
public class TestCacheDirectives {
  ...
  private static void waitForCachedBlocks(NameNode nn,
    ...
    GenericTestUtils.waitFor(new Supplier<Boolean>() {
      ...
      public Boolean get() {
        ...
        namesystem.readLock(RwLockMode.BM, "checkBlocks");
        try {
  ...
  private void checkPendingCachedEmpty(MiniDFSCluster cluster)
      throws Exception {
    Thread.sleep(1000);
    cluster.getNamesystem().readLock(RwLockMode.BM, "checkPendingCachedEmpty");
    try {
  ...
  public void testExpiryTimeConsistency() throws Exception {
    ...
    GenericTestUtils.waitFor(() -> {
      ...
      ann.getNamesystem().readLock(RwLockMode.FS, "expiryTimeConsistency");
      try {
        sbn.getNamesystem().readLock(RwLockMode.FS, "expiryTimeConsistency");
        try {
