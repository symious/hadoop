...
public class TestStoreDriverBase {
  ...
  public <T extends BaseRecord> void testGet(StoreDriver driver, Class<T> clazz)
    ...
    assertEquals(r0, result.getRecords().get(0));
  ...
  private String generateRandomString() {
    return "randomString-" + new Random().nextInt();
  }
}