...
public class TestDFSNetworkTopologyWithDataCenter {
  ...
  //  LogFactory.getLog(TestDFSNetworkTopologyWithDataCenter.class);
  ...
  public void testGetDataCenter() {
    assertEquals("/d3", DFSNetworkTopologyWithDataCenter.getDataCenter("/d3/r2"));
  }
  ...
  public void testChooseRandom() {
    ...
    for (int i = 0; i<10; i++) {
      ...
      assertTrue(n instanceof DatanodeDescriptor);
      dd = (DatanodeDescriptor) n;
      assertTrue(DFSNetworkTopologyWithDataCenter.getDataCenter(dd.getNetworkLocation()).equals("/d1") ||
        DFSNetworkTopologyWithDataCenter.getDataCenter(dd.getNetworkLocation()).equals("/d2") ||
        DFSNetworkTopologyWithDataCenter.getDataCenter(dd.getNetworkLocation()).equals("/d3"));
    }
    ...
    for (int i = 0; i<10; i++) {
      ...
      assertTrue(dd.getHostName().equals("host6") ||
        dd.getHostName().equals("host7") || dd.getHostName().equals("host8"));
    }
  }
