...
public class TestRouterHandlerQueue {
   ...
   */
  static class RouterRpcClientDummy extends RouterRpcClient {
  ...
  private void setupMocks() {
    ...
    for (RouterContext router : cluster.getRouters()) {
      ...
      RouterRpcClientDummy dummyClient = new RouterRpcClientDummy(server.getConfig(),
          router.getRouter(), server.getNamenodeResolver(), server.getRPCMonitor());
