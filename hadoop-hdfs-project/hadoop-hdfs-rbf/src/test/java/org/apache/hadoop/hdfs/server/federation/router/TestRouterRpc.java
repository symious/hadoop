...
public class TestRouterRpc {
  ...
  public void testProxyGetAdditionalDatanode()
    ...
    LocatedBlock newBlock = routerProtocol.getAdditionalDatanode(
        ...
        block.getLocations(), block.getStorageIDs(), DatanodeInfo.EMPTY_ARRAY, 1, clientName);
  ...
  public void testRenewLeaseForECFile() throws Exception {
    ...
    FederationRPCMetrics metrics = router.getRouter().getRpcServer().getRPCMetrics();
  ...
  public void testSetBalancerBandwidth() throws Exception {
    ...
    GenericTestUtils.waitFor(() -> datanodes.get(0).getBalancerBandwidth() == newBandwidth, 100, 60 * 1000);
  }
}