 ...
 * Internally a Semaphore is used to control shared permits
 */
public class ElasticRouterRpcFairnessPolicyController
  ...
  private final ConcurrentHashMap<String, MutableCounterLong>
      nsElasticPermitsAcquired;

  public ElasticRouterRpcFairnessPolicyController(Configuration conf) {
    super(conf);
    init(conf);
  ...
  private void init(Configuration conf) {
    ...
    for (String nsId : allConfiguredNS) {
      ...
      AbstractPermitManager permitManager = new ElasticPermitManager(
          ...
          this.totalElasticPermits, getMaxWaitingTime());
