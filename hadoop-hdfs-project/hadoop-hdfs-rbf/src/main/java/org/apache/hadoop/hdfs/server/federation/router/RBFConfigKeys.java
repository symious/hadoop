...
public class RBFConfigKeys extends CommonConfigurationKeysPublic {
  ...
  public static final String DFS_ROUTER_OBSERVER_READ_ENABLE = FEDERATION_ROUTER_PREFIX
      + "observer.read.enable";
  public static final boolean DFS_ROUTER_OBSERVER_READ_ENABLE_DEFAULT = false;

  public static final String DFS_ROUTER_OBSERVER_AUTO_MSYNC_PERIOD = FEDERATION_ROUTER_PREFIX
  ...
  public static final String  DFS_ROUTER_ENABLE_AUDIT_LOG_KEY = "dfs.router.enable.audit.loggers";
  public static final boolean DFS_ROUTER_ENABLE_AUDIT_LOG_DEFAULT = true;
  public static final String DFS_ROUTER_AUDIT_LOGGERS_KEY = "dfs.router.audit.loggers";
  ...
  public static final boolean DFS_ROUTER_AUDIT_LOG_TOKEN_TRACKING_ID_DEFAULT = false;
  public static final String DFS_ROUTER_AUDIT_LOG_ASYNC_KEY = "dfs.router.audit.log.async";
