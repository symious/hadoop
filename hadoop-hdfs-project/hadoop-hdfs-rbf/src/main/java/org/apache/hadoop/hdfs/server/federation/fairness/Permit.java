 ...
 */
public class Permit {
  public static Permit PERMIT_NOT_REQUIRED =
      new Permit(PermitType.PERMIT_NOT_REQUIRED, 0);
  ...
  public boolean isPermitNotRequired() {
    return this.permitType.equals(PermitType.PERMIT_NOT_REQUIRED);
  }

  @Override
  public String toString() {
    return "Permit[permitType=" + permitType + ",version=" + permitVersion + "]";
  }
