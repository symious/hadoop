...
public interface HdfsClientConfigKeys {
  ...
  String  DFS_WEBHDFS_USER_RPCPASSWORD_PATTERN_KEY =
      "dfs.webhdfs.user.rpcpassword.provider.user.pattern";
  String  DFS_WEBHDFS_USER_RPCPASSWORD_PATTERN_DEFAULT = "^[A-Za-z0-9][A-Za-z0-9\\s]*[A-Za-z0-9]$";
  ...
  String  DFS_CLIENT_TREAT_SLOWNODE_AS_BADNODE_KEY =
      "dfs.client.treat.slownode.as.badnode";
  boolean DFS_CLIENT_TREAT_SLOWNODE_AS_BADNODE_DEFAULT = false;
  String  DFS_CLIENT_TREAT_SLOWNODE_AS_BADNODE_THRESHOLD_KEY =
      "dfs.client.treat.slownode.as.badnode.threshold";
  int DFS_CLIENT_TREAT_SLOWNODE_AS_BADNODE_THRESHOLD_DEFAULT = 10;
  ...
  interface StripedRead {
     ...
     */
    String DATANODE_MAX_ATTEMPTS = PREFIX + "datanode.max.attempts";
