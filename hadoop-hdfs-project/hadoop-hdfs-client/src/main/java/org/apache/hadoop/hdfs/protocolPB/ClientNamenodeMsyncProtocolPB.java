...
@ProtocolInfo(protocolName = HdfsConstants.CLIENT_NAMENODE_MSYNC_PROTOCOL_NAME,
    protocolVersion = 1)
/**
 ...
 */
public interface ClientNamenodeMsyncProtocolPB extends
    ClientNamenodeMsyncProtocol.BlockingInterface {
}
