...
public class StripedBlockUtil {
   ...
   */
  public static LocatedBlock constructInternalBlock(
      LocatedStripedBlock bg, int idxInReturnedLocs,
  ...
  public static long getInternalBlockLength(long dataSize,
      ErasureCodingPolicy ecPolicy, int idxInBlockGroup) {
   ...
   */
  public static long getSafeLength(
      ErasureCodingPolicy ecPolicy, long[] blockLens) {
  ...
  private static int lastCellSize(int size,
   ...
   * the block group.
   */
  public static long offsetInBlkToOffsetInBG(
      int cellSize, int dataBlkNum,
  ...
  private static AlignedStripe[] mergeRangesForInternalBlocks(
    ...
    return stripes.toArray(new AlignedStripe[0]);
  }
  ...
  public static class StripingCell {
    ...
    StripingCell(ErasureCodingPolicy ecPolicy,
        int cellSize, long idxInBlkGroup, long offset) {
