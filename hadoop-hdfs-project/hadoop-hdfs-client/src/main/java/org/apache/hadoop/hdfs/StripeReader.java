...
abstract class StripeReader {
  ...
  private int readToBuffer(BlockReader blockReader,
      ...
      LocatedBlock currentBlock, int chunkIndex, long offsetInBlock) throws IOException {
    ...
    while (true) {
      ...
      try {
        ...
        DFSClient.LOG.warn("Found Checksum error for {} from {} at {}", currentBlock,
            currentNode, ce.getPos());
        ...
        if (curAttempts < readDNMaxAttempts) {
          ...
          if (dfsStripedInputStream.createBlockReader(currentBlock,
              offsetInBlock, targetBlocks, readerInfos, chunkIndex, readTo)) {
        ...
        DFSClient.LOG.warn("Exception while reading from {} of {} from {}", currentBlock,
            dfsStripedInputStream.getSrc(), currentNode, e);
        throw e;
      }
    }
  }
