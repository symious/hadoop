...
public class StripedDataStreamer extends DataStreamer {
  ...
  StripedDataStreamer(HdfsFileStatus stat,
    ...
    super(stat, null, dfsClient, src, progress, checksum,
        cachingStrategy, byteArrayManage, favoredNodes, flags);
    this.index = index;
  ...
  protected LocatedBlock nextBlockOutputStream() throws IOException {
    ...
    success = createBlockOutputStream(nodes, storageTypes, 0L,
        false);
  ...
  @Override
  protected void setupPipelineInternal(
      DatanodeInfo[] nodes, StorageType[] nodeStorageTypes)
      throws IOException {
