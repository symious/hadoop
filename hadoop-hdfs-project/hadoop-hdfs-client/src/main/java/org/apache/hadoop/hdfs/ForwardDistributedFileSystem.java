...
public class ForwardDistributedFileSystem extends DistributedFileSystem {
  ...
  public void setWorkingDirectory(Path dir) {
    if (useUnderFs()) {
      underFs.setWorkingDirectory(dir);
    } else {
  ...
  public boolean recoverLease(final Path f) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "recoverLease");
    } else {
  ...
  public FSDataOutputStream append(Path f, final EnumSet<CreateFlag> flag,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri,
          "append(f, flag, bufferSize, progress)");
    } else {
  ...
  public FSDataOutputStream append(Path f, final EnumSet<CreateFlag> flag,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri,
          "append(f, flag, bufferSize, progress, favoredNodes)");
    } else {
  ...
  public HdfsDataOutputStream create(final Path f,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri,
          "create(f, permission, overwrite, bufferSize, replication," +
  ...
  public FSDataOutputStream createNonRecursive(final Path f,
      ...
      final Progressable progress) throws IOException {
    if (useUnderFs()) {
      return underFs.createNonRecursive(divePath(f), permission, flag, bufferSize,
          replication, blockSize, progress);
    } else {
  ...
  public Collection<BlockStoragePolicy> getAllStoragePolicies()
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getAllStoragePolicies");
    } else {
  ...
  public void setQuota(Path src, final long namespaceQuota,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "setQuota");
    } else {
  ...
  public boolean mkdir(Path f, FsPermission permission) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "mkdir");
    } else {
      return mkdir(f, permission);
    }
  }
  ...
  protected boolean primitiveMkdir(Path f, FsPermission absolutePermission)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "primitiveMkdir");
    } else {
  ...
  public DistributedFileSystem.DiskStatus getDiskStatus() throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getDiskStatus");
    } else {
  ...
  public long getRawCapacity() throws IOException{
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getRawCapacity");
    } else {
  ...
  public long getRawUsed() throws IOException{
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getRawUsed");
    } else {
  ...
  public long getMissingBlocksCount() throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getMissingBlocksCount");
    } else {
  ...
  public long getCorruptBlocksCount() throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getCorruptBlocksCount");
    } else {
  ...
  public RemoteIterator<Path> listCorruptFileBlocks(final Path path)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "listCorrutFileBlocks");
    } else {
  ...
  public boolean setSafeMode(HdfsConstants.SafeModeAction action)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "setSafeMode");
    } else {
  ...
  public boolean restoreFailedStorage(String arg) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "restoreFailedStorage");
    } else {
  ...
  public boolean refreshTopology(String ipAddr) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "refreshTopology");
    } else {
      return super.refreshTopology(ipAddr);
    }
  }
  ...
  public RollingUpgradeInfo rollingUpgrade(
      ...
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "rollingUpgrade");
    } else {
  ...
  public void metaSave(String pathname) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "metaSave");
    } else {
  ...
  public void msync() throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "msync");
    } else {
      super.msync();
    }
  }
  ...
  protected Path resolveLink(Path f) throws IOException {
    if (useUnderFs()) {
      return floatPath(underFs.resolvePath(divePath(f)));
    } else {
  ...
  public Token<DelegationTokenIdentifier> getDelegationToken(String renewer)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getDelegationToken");
    } else{
  ...
  public void setBalancerBandwidth(long bandwidth) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "setBalancerBandwidth");
    } else {
  ...
  public void allowSnapshot(final Path path) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "allowSnapshot");
    } else {
  ...
  public void disallowSnapshot(final Path path) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "disallowSnapshot");
    } else {
  ...
  public Path createSnapshot(final Path path, final String snapshotName)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "createSnapshot");
    } else {
  ...
  public void renameSnapshot(final Path path, final String snapshotOldName,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "renameSnapshot");
    } else {
  ...
  public void deleteSnapshot(final Path snapshotDir, final String snapshotName)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "deleteSnapshot");
    } else {
  ...
  public SnapshotDiffReport getSnapshotDiffReport(final Path snapshotDir,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getSnapshotDiffReport");
    } else {
  ...
  public boolean isFileClosed(final Path src) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "isFileClosed");
    } else {
  ...
  public long addCacheDirective(CacheDirectiveInfo info) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "addCacheDirective");
    } else {
  ...
  public void modifyCacheDirective(CacheDirectiveInfo info) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "modifyCacheDirective");
    } else {
  ...
  public void removeCacheDirective(long id)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "removeCacheDirective");
    } else {
  ...
  public RemoteIterator<CacheDirectiveEntry> listCacheDirectives(
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "listCacheDirectives");
    } else {
  ...
  public void addCachePool(CachePoolInfo info) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "addCachePool");
    } else {
  ...
  public void modifyCachePool(CachePoolInfo info) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "modifyCachePool");
    } else {
  ...
  public void removeCachePool(String poolName) throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "removeCachePool");
    } else {
  ...
  public void createEncryptionZone(final Path path, final String keyName)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "createEncryptionZone");
    } else {
  ...
  public FileEncryptionInfo getFileEncryptionInfo(final Path path)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getFileEncryptionInfo");
    } else {
  ...
  public void provisionEZTrash(final Path path,
    ...
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "provisionEZTrash");
    } else {
  ...
  public Token<?>[] addDelegationTokens(
    ...
    if (useUnderFs()) {
      return underFs.addDelegationTokens(renewer, credentials);
    } else {
  ...
  public DFSInotifyEventInputStream getInotifyEventStream() throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getInotifyEventStream");
    } else {
  ...
  public String getTrashRootConfig() {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getTrashRootConfig");
    } else {
      return super.getTrashRootConfig();
    }
  }
  ...
  public Collection<FileStatus> getTrashRootsConfig(boolean allUsers)
      throws IOException {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "getTrashRootsConfig");
    } else {
      return super.getTrashRootsConfig(allUsers);
    }
  }
  ...
  public Collection<FileStatus> getTrashRoots(boolean allUsers) {
    if (useUnderFs()) {
      return underFs.getTrashRoots(allUsers);
    } else {
  ...
  public DistributedFileSystem.HdfsDataOutputStreamBuilder createFile(Path path) {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "createFile");
    } else {
  ...
  public DistributedFileSystem.HdfsDataOutputStreamBuilder appendFile(Path path) {
    if (useUnderFs()) {
      throw new UnderFSNotSupportedOperation(underUri, "appendFile");
    } else {
