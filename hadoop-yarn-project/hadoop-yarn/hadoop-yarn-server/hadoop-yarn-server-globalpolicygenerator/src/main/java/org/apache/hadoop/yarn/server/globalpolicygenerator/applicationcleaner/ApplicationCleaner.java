...
public abstract class ApplicationCleaner implements Runnable {
  ...
  public String getQueryTimeLineAddress(){
    return this.conf.get(YarnConfiguration.GPG_QUERY_TIMELINE_WEBAPP_ADDRESS,
        YarnConfiguration.DEFAULT_GPG_QUERY_TIMELINE_WEBAPP_ADDRESS);
  }

  public long getAppHomeExpireMinTime(){
    return this.conf.getLong(YarnConfiguration.GPG_APP_MIN_EXPIRATION_MS,
