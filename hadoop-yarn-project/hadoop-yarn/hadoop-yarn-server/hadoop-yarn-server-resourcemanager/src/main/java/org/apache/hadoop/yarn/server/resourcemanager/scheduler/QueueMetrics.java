...
public class QueueMetrics implements MetricsSource {
  ...
  public void fastPreemptContainer() {
    aggregateContainersFastPreempted.incr();
    if (parent != null) {
      parent.fastPreemptContainer();
    }
  }
  ...
  public void updateEffectiveMetric(long effectiveMB, long maxEffectiveMB, int effectiveVCores,
