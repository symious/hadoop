...
public class RouterAuditLogger {
  ...
  enum Keys {
    USER, OPERATION, TARGET, RESULT, IP, PERMISSIONS, DESCRIPTION, APPID,
    SUBCLUSTERID }
  ...
  public static void logSuccess(String user, String operation, String target,
    ...
    if (LOG.isInfoEnabled()) {
      LOG.info(createSuccessLog(user, operation, target, Server.getRemoteIp(),
          appId, null));
    }
  }
  ...
  static String createSuccessLog(String user, String operation, String target,
      InetAddress ip, ApplicationId appId, SubClusterId subClusterID) {
    StringBuilder b =
  ...
  public static void logFailure(String user, String operation, String perm,
    ...
    if (LOG.isInfoEnabled()) {
      LOG.info(createFailureLog(user, operation, perm, target, Server.getRemoteIp(),
  ...
  public static void logFailure(String user, String operation, String perm,
    ...
    if (LOG.isInfoEnabled()) {
      LOG.info(
          createFailureLog(user, operation, perm, target, Server.getRemoteIp(),
  ...
  public static void logFailure(String user, String operation, String perm,
    ...
    if (LOG.isInfoEnabled()) {
      LOG.info(createFailureLog(user, operation, perm, target, Server.getRemoteIp(),
          description, appId, subClusterId));
    }
  }
  ...
  static String createFailureLog(String user, String operation, String perm,
      String target,  InetAddress ip, String description, ApplicationId appId,
      SubClusterId subClusterId) {
    StringBuilder b =
        createStringBuilderForFailureLog(user, operation, target, ip,
            description, perm);
    if (appId != null) {
      add(Keys.APPID, appId.toString(), b);
    }
  ...
  private static StringBuilder createStringBuilderForFailureLog(String user,
      String operation, String target,  InetAddress ip, String description,
      String perm) {
    StringBuilder b = new StringBuilder();
    start(Keys.USER, user, b);
    add(Keys.OPERATION, operation, b);
