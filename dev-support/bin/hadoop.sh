...
function personality_globals
{
  ...
  BUILDTOOL=maven
  #shellcheck disable=SC2034
  PATCH_BRANCH_DEFAULT=shopee-2.10
  #shellcheck disable=SC2034
  PATCH_NAMING_RULE="https://wiki.apache.org/hadoop/HowToContribute"
  #shellcheck disable=SC2034
  JIRA_ISSUE_RE='^(SPDI|HADOOP|YARN|MAPREDUCE|HDFS|HDDS|SUBMARINE)-[0-9]+$'
  #shellcheck disable=SC2034
  JIRA_URL='https://jira.shopee.io/browse'
  #shellcheck disable=SC2034
  PYLINT_OPTIONS="--indent-string='  '"

  #shellcheck disable=SC2034
  GITLAB_BASE_URL="https://git.garena.com"
  #shellcheck disable=SC2034
  GITLAB_API_URL="https://git.garena.com/api/v4"
  #shellcheck disable=SC2034
  GITLAB_REPO="shopee/data-infra/hadoop"
...
function personality_modules
{
  ...
  yetus_error "Personality: ${repostatus} ${testtype}"
