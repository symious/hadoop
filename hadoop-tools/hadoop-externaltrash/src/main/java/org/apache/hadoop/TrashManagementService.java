...
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_TRASH_NAMESERVICES_KEY;
import static org.apache.hadoop.util.ExitUtil.terminate;

public class TrashManagementService {
  public static final Logger LOG =
      LoggerFactory.getLogger(TrashManagementService.class);
  ...
  private void loadConfig() {
    ...
    deleteIntervalDefault = trashConf.getLong(FS_TRASH_INTERVAL_KEY,
  ...
  public static void createTrashService(String[] argv, Configuration conf)
      throws IOException {
  ...
  public static void main(String[] arg) {
    if (DFSUtil.parseHelpArgument(arg, TrashManagementService.USAGE, System.out, true)) {
      System.exit(0);
    }
