...
public class CopyMapper extends Mapper<Text, CopyListingFileStatus, Text, Text> {
  ...
  static EnumSet<DistCpOptions.FileAttribute> getFileAttributeSettings(Mapper.Context context) {
  ...
  private void copyFileWithRetry(String description,
      ...
      EnumSet<DistCpOptions.FileAttribute> fileAttributes, FileStatus sourceStatus)
  ...
  private void createTargetDirsWithRetry(String description,
      Path target, Context context, FileStatus sourceStatus) throws IOException {
    try {
