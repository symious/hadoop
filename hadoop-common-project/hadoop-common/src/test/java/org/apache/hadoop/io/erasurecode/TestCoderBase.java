...
public abstract class TestCoderBase {
  ...
  protected void compareAndVerify(
      ECChunk[] erasedChunks, ECChunk[] recoveredChunks) {
   ...
   */
  protected ECChunk[] prepareInputChunksForDecoding(
      ECChunk[] dataChunks, ECChunk[] parityChunks) {
   ...
   */
  protected ECChunk[] backupAndEraseChunks(
      ECChunk[] dataChunks, ECChunk[] parityChunks) {
