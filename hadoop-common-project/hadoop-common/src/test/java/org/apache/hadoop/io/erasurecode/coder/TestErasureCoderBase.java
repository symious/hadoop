...
public abstract class TestErasureCoderBase extends TestCoderBase {
   ...
   * blocks data.
   */
  protected void compareAndVerify(
      ECBlock[] erasedBlocks, ECBlock[] recoveredBlocks) {
   ...
   */
  protected TestBlock[] backupAndEraseBlocks(
      TestBlock[] dataBlocks, TestBlock[] parityBlocks) {
    TestBlock[] toEraseBlocks = new TestBlock[
        erasedDataIndexes.length + erasedParityIndexes.length];
    int idx = 0;
    TestBlock block;
