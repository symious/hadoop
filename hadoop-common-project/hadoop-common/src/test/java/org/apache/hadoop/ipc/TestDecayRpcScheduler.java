...
public class TestDecayRpcScheduler {
  ...
  @Test
  @SuppressWarnings("deprecation")
  public void testParseConfiguredUsers() {
    // Default
    scheduler = new DecayRpcScheduler(1, "", new Configuration());
    assertEquals(DecayRpcScheduler.IPC_SCHEDULER_DECAYSCHEDULER_FACTOR_DEFAULT,
        scheduler.getDecayFactor(), 0.00001);
    ...
    // Custom
    Configuration conf = new Configuration();
    conf.set("prefix." + DecayRpcScheduler.IPC_DECAYSCHEDULER_STATIC_USER_PREFIX + 1, "1_user");
    conf.set("prefix." + DecayRpcScheduler.IPC_DECAYSCHEDULER_STATIC_USER_PREFIX + 2, "2_user");
    conf.set("prefix." + DecayRpcScheduler.IPC_DECAYSCHEDULER_STATIC_USER_PREFIX + 3, "3_user");
