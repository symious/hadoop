...
/**
 * Credentials provider based on SDI configuration profiles. This provider vends SDICredentials from
 * the profile configuration file for the default profile, or for a specific, named profile. <p>
 *
 */
public class ProfileCredentialsProvider implements SDICredentialsProvider {
  ...
  /**
   * Creates a new profile credentials provider that returns the SDI security credentials
  ...
  /**
   * Creates a new profile credentials provider that returns the SDI security credentials for the
