...
public class CrcComposer {
   ...
   * value.
   */
  public static CrcComposer newCrcComposer(DataChecksum.Type type,
      long bytesPerCrcHint) throws IOException {
  ...
  protected CrcComposer(int crcPolynomial,
   ...
   */
  public void update(byte[] crcBuffer,
      int offset, int length, long bytesPerCrc)
      throws IOException {
   ...
   */
  public byte[] digest() {
    return digestInternal(true);
  }

  protected byte[] digestInternal(boolean resetDigest) {
