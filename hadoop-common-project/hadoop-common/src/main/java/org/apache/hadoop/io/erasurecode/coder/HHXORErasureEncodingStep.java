...
public class HHXORErasureEncodingStep extends HHErasureCodingStep {
  ...
  private final RawErasureEncoder rsRawEncoder;
   ...
   */
  public HHXORErasureEncodingStep(
      ECBlock[] inputBlocks, ECBlock[] outputBlocks,
  ...
  private void encodeWithPiggyBacks(ByteBuffer[] piggyBacks,
      ByteBuffer[][] outputs, int numParityUnits,
      boolean bIsDirect) {
    if (!bIsDirect) {
